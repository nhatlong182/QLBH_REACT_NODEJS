...
const data = {
    ...
    products: [
        ...
        },
        {
            ...
            countInStock: 0,
            brand: 'Gamble',
            description: 'Là một item quen thuộc trên các sân thể thao trường học, nhưng khi đến Gamble, chiếc áo Varsity Jacket đã được nâng tầm và cách điệu phù hợp với mọi sự kiện, hoạt động và thời điểm. Gamble Varsity Jacket chắc chắn sẽ đồng hành trên chặng đường dài cùng bạn.',
        },
        {
